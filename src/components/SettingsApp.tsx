...
const SettingsApp: React.FC = () => {
  ...
  return (
    <div className="h-full bg-gradient-to-br from-violet-50 to-purple-50 flex relative overflow-hidden">
      {/* Kawaii Stickers */}
      {showStickers && (
      ...
      {/* Sidebar */}
      <div className="w-64 bg-violet-50/90 backdrop-blur-sm border-r border-violet-200/70 p-4">
        <div className="mb-6">
      ...
      <div className="flex-1 p-6 overflow-y-auto">
        {activeSection === 'appearance' && (
          <div className="space-y-6">
            <div className="bg-violet-50/90 backdrop-blur-sm rounded-xl p-6 border border-violet-200/70 shadow-lg">
              <h3 className="text-xl font-bold text-gray-800 mb-4 flex items-center">
                <Palette className="w-5 h-5 mr-2 text-violet-500" />
                Appearance Settings
              </h3>
        ...
        {activeSection === 'sound' && (
          <div className="space-y-6">
            <div className="bg-white bg-opacity-80 backdrop-blur-sm rounded-xl p-6 border border-violet-200 shadow-lg">
              <h3 className="text-xl font-bold text-gray-800 mb-4 flex items-center">
            ...
            <div className="bg-white bg-opacity-80 backdrop-blur-sm rounded-xl p-6 border border-violet-200 shadow-lg">
              ...
              <div className="space-y-4">
                ...
                <div className="bg-violet-50 rounded-lg p-4 border border-violet-200">
                  <h4 className="font-semibold text-violet-800 mb-2">Kawaii Stats</h4>
                  <div className="grid grid-cols-2 gap-4 text-sm">
                    <div className="text-center">
                      <div className="text-2xl">💕</div>
                      <div className="text-violet-600">Love Level: MAX</div>
                    </div>
                    <div className="text-center">
                      <div className="text-2xl">✨</div>
                      <div className="text-violet-600">Sparkles: Infinite</div>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="mt-8 text-center space-y-4">
          <button
            ...
            className="inline-flex items-center space-x-2 bg-gradient-to-r from-violet-400 to-purple-400 text-white px-6 py-3 rounded-full hover:scale-105 transition-all duration-200 shadow-lg hover:shadow-xl"
          >
            <RotateCcw className="w-4 h-4" />
            <span className="font-medium">Reset All Settings</span>
          </button>
          
          <div className="inline-flex items-center space-x-2 bg-white bg-opacity-60 rounded-full px-4 py-2 border border-violet-200">
...
const ToggleOption: React.FC<ToggleOptionProps> = ({ 
  ...
  return (
    <div className={`flex items-center justify-between p-4 rounded-lg border transition-all duration-200 hover:shadow-md ${
      disabled ? 'bg-gray-50 border-gray-200' : 'bg-white border-violet-200 hover:border-violet-300'
    }`}>
      <div className="flex items-center space-x-3">
        <div className={`p-2 rounded-lg ${disabled ? 'bg-gray-200' : 'bg-violet-100'}`}>
          <Icon className={`w-5 h-5 ${disabled ? 'text-gray-400' : 'text-violet-500'}`} />
        </div>
        <div>
        ...
        <div className={`relative w-11 h-6 rounded-full transition-colors duration-200 ${
          disabled 
            ...
            : checked 
              ...
              : 'bg-gray-200'
        } peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-violet-300`}>
